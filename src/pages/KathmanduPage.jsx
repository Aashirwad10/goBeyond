        ...
        <div>
                ...
                <div className="pokhara-carousel">
                    <div className="pokhara-carousel-inner" ref={carouselInnerRef}>
                        ...
                        <div className="pokhara-carousel-item">
                            <img src={kathmandu} alt="Pokhara Image 2" />
                        </div>
                        <div className="pokhara-carousel-item">
                            <img src={kathmandu} alt="Pokhara Image 3" />
                        </div>
                        <div className="pokhara-carousel-item">
                            <img src={kathmandu} alt="Pokhara Image 4" />
                        </div>
                    </div>
            ...
            <section className="pokhara-content">
                <div className="pokhara-content-item">
                    <img src={kathmandu} alt="Image 1" className="pokhara-content-image" />
                ...
                <div className="pokhara-content-item">
                    <img src={kathmandu} alt="Image 2" className="pokhara-content-image" />
                    <div className="pokhara-content-desc">
                        <h2>Place Title 2</h2>
                ...
                <div className="pokhara-content-item">
                    <img src={kathmandu} alt="Image 3" className="pokhara-content-image" />
                    <div className="pokhara-content-desc">
                        <h2>Place Title 3</h2>
                ...
                <div className="pokhara-content-item">
                    <img src={kathmandu} alt="Image 4" className="pokhara-content-image" />
                    <div className="pokhara-content-desc">
                        <h2>Place Title 4</h2>
            ...
            <section className="pokhara-gallery">
                ...
                <div className="pokhara-gallery-item">
                    <img src={kathmandu} alt="Gallery Image 2" />
                </div>
                <div className="pokhara-gallery-item">
                    <img src={kathmandu} alt="Gallery Image 3" />
                </div>
                <div className="pokhara-gallery-item">
                    <img src={kathmandu} alt="Gallery Image 4" />
                </div>
            </section>
        </div>
    );
